...
export function deriveStreetAddress(rule: StreetDerivationRule): RealAddress {
  ...
  // Calculate linear GIS coordinate interpolation along corridor centerline
  // Clamp between 0.05 and 0.95 to keep coordinates well within the corridor bounds (avoiding intersection centers)
  ...
  return {
    ...
    derivationMeta: {
      mode: 'derivation',
      modeLabelZh: '方案A·真实居住街区门牌衍生',
      modeLabelEn: 'Scheme A: Residential Street Derivation',
      baseStreet: rule.streetName,
      houseNumberRange: `#${min} - #${max}`,
      ruleSummary: `${rule.streetName} (#${min} - #${max}) GIS 航向线性插值`,
      interpolated: true,
      buildingType: 'residential',
      avsTier: 'Residential Street (GIS Validated)'
    }
  };
}
...
export const STREET_DERIVATION_RULES: StreetDerivationRule[] = [
  ...
  // --- 特拉华州 (DE) ---
  {
    ...
    countryCode: 'US',
    startCoord: { lat: 39.7345, lng: -75.6359 },
    endCoord: { lat: 39.7219, lng: -75.6615 },
    isTaxFree: true,
  ...
  },
  {
    ...
    country: 'United States',
    countryCode: 'US',
    startCoord: { lat: 39.7856, lng: -75.5461 },
    endCoord: { lat: 39.8255, lng: -75.5450 },
    isTaxFree: true,
    taxRate: '0.00% (No Sales Tax)',
    timezone: 'America/New_York (EST/EDT)',
    timezoneCode: 'EST'
  },
  {
    ...
    country: 'United States',
    countryCode: 'US',
    startCoord: { lat: 39.6893, lng: -75.7328 },
    endCoord: { lat: 39.7009, lng: -75.6996 },
    isTaxFree: true,
    taxRate: '0.00% (No Sales Tax)',
    timezone: 'America/New_York (EST/EDT)',
    timezoneCode: 'EST'
  },
  {
    ...
    country: 'United States',
    countryCode: 'US',
    startCoord: { lat: 39.6328, lng: -75.6598 },
    endCoord: { lat: 39.6186, lng: -75.6946 },
    isTaxFree: true,
    taxRate: '0.00% (No Sales Tax)',
    timezone: 'America/New_York (EST/EDT)',
    timezoneCode: 'EST'
  },
  {
    ...
    country: 'United States',
    countryCode: 'US',
    startCoord: { lat: 39.7379, lng: -75.6859 },
    endCoord: { lat: 39.7455, lng: -75.6980 },
    isTaxFree: true,
    taxRate: '0.00% (No Sales Tax)',
    timezone: 'America/New_York (EST/EDT)',
    timezoneCode: 'EST'
  ...
  // --- 伊利诺伊州 (IL) ---
  {
    ...
    country: 'United States',
    countryCode: 'US',
    startCoord: { lat: 41.9185, lng: -87.6432 },
    endCoord: { lat: 41.9430, lng: -87.6710 },
    isTaxFree: false,
    taxRate: '10.25%',
    timezone: 'America/Chicago (CST/CDT)',
    timezoneCode: 'CST'
  ...
  // --- 新泽西州 (NJ) ---
  {
    ...
    endCoord: { lat: 40.7290, lng: -74.0340 },
    isTaxFree: false,
    taxRate: '6.625%',
    timezone: 'America/New_York (EST/EDT)',
    timezoneCode: 'EST'
  ...
  // --- 内华达州 (NV) ---
  {
    ...
    country: 'United States',
    countryCode: 'US',
    startCoord: { lat: 36.1450, lng: -115.1370 },
    endCoord: { lat: 36.1600, lng: -115.1370 },
    isTaxFree: false,
    taxRate: '8.375%',
    timezone: 'America/Los_Angeles (PST/PDT)',
    timezoneCode: 'PST'
  ...
  },
  {
    ...
    country: 'United Kingdom',
    countryCode: 'GB',
    startCoord: { lat: 52.4865, lng: -1.9125 },
    endCoord: { lat: 52.4890, lng: -1.9180 },
    taxRate: '20% VAT',
    timezone: 'Europe/London (GMT/BST)',
    timezoneCode: 'GMT'
  },
  ...
  // ==========================================
  {
    ...
    endCoord: { lat: 43.7050, lng: -79.3980 },
    taxRate: '13% HST',
  ...
  },
  {
    ...
    endCoord: { lat: 49.2900, lng: -123.1350 },
    taxRate: '12% GST/PST',
  ...
  },
  {
    ...
    country: 'Canada',
    countryCode: 'CA',
    startCoord: { lat: 51.0395, lng: -114.0720 },
    endCoord: { lat: 51.0395, lng: -114.0930 },
    isTaxFree: true,
  ...
  },
  {
    ...
    country: 'Germany',
    countryCode: 'DE',
    startCoord: { lat: 50.1240, lng: 8.7010 },
    endCoord: { lat: 50.1345, lng: 8.7085 },
    taxRate: '19% MwSt',
    timezone: 'Europe/Berlin (CET)',
    timezoneCode: 'CET'
  },
  ...
  // ==========================================
  {
    ...
    country: 'Taiwan',
    countryCode: 'TW',
    startCoord: { lat: 25.0270, lng: 121.5310 },
    endCoord: { lat: 25.0315, lng: 121.5315 },
    taxRate: '5% 營業稅',
  ...
  // ==========================================
  {
    ...
    country: 'Hong Kong',
    countryCode: 'HK',
    startCoord: { lat: 22.2805, lng: 114.1505 },
    endCoord: { lat: 22.2825, lng: 114.1450 },
    isTaxFree: true,
    taxRate: '0.00% (No Sales Tax)',
  ...
  // ==========================================
  {
    ...
    country: 'Singapore',
    countryCode: 'SG',
    startCoord: { lat: 1.3215, lng: 103.8050 },
    endCoord: { lat: 1.3260, lng: 103.8095 },
    taxRate: '9% GST',
  ...
  // ==========================================
  {
    ...
    endCoord: { lat: 47.3740, lng: 8.5395 },
    isTaxFree: true,
    taxRate: '8.1% (低税特区)',
  ...
  },
  {
    ...
    country: 'Luxembourg',
    countryCode: 'LU',
    startCoord: { lat: 49.6035, lng: 6.1310 },
  ...
  // ==========================================
  {
    ...
    country: 'South Korea',
    countryCode: 'KR',
    startCoord: { lat: 37.4930, lng: 127.0510 },
    endCoord: { lat: 37.4980, lng: 127.0650 },
    taxRate: '10% VAT',
  ...
  // ==========================================
  {
    ...
    country: 'Vietnam',
    countryCode: 'VN',
    startCoord: { lat: 10.7890, lng: 106.7160 },
    endCoord: { lat: 10.7960, lng: 106.7210 },
    taxRate: '10% VAT',
  ...
  // ==========================================
  {
    ...
    country: 'Philippines',
    countryCode: 'PH',
    startCoord: { lat: 14.5530, lng: 121.0160 },
    endCoord: { lat: 14.5580, lng: 121.0195 },
    taxRate: '12% VAT',
